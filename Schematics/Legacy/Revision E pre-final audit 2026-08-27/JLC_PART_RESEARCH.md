# JLC/LCSC part research — Revision D

Checked **2026-08-26**. Inventory and small-quantity pricing are volatile; the JLC BOM uploader remains the authoritative order-time check. Every selected IC/module currently has a JLC part page that identifies it as compatible with **Economic and Standard** PCBA.
...
| 915 MHz radio with I-PEX | Ai-Thinker Ra-01SH / SX1262 | C2764087 | Extended | JLC Economic+Standard; LCSC 1,507 stock and $4.6299 at qty 1 snapshot |
...
| I2S microphone | ICS-43432 | C574021 | Extended | JLC Economic+Standard, high-difficulty; 246 stock and $5.1108 snapshot |
...
The ESP32 no longer needs an external antenna connector. Its PCB antenna faces a board edge and has a rule-area copper/track/via keepout. The external 915 MHz antenna attaches to U8's I-PEX socket at the top edge.
...
- 63 JLC-placed components per PCBA.
- 17 Basic BOM lines / 50 Basic placements.
